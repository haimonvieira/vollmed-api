...
//Dizendo para o Spring usar o meu banco de dados, nao o banco de dados em memória
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
@ActiveProfiles("test")//dizendo ao Spring para ler o 'application-test.properties'
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver 'null' quando único médico cadastrado não está disponível" +
            "na data")
    void escolherMedicoAleatorioLivreNaDataCenario1() {

        //Cadastro as informacoes
        //Given / arrange
        ...
        //Executo a acao que quero testar
        //When / act
